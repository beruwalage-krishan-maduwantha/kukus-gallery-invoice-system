            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="money" style={{ textAlign: 'right' }}>{formatCurrency(data?.totalInvoiceValue || 0)}</td>
                ...
                <tr>
                  ...
                  <td className="money" style={{ textAlign: 'right' }}>{formatCurrency(data?.totalQuotationValue || 0)}</td>
                ...
                <tr>
                  ...
                  <td className="money" style={{ textAlign: 'right', color: 'var(--success)' }}>{formatCurrency(data?.totalSell || 0)}</td>
                ...
                <tr>
                  ...
                  <td className="money" style={{ textAlign: 'right', color: '#6366F1' }}>{formatCurrency(data?.totalConvertedValue || 0)}</td>
                ...
                <tr>
                  ...
                  <td className="money" style={{ textAlign: 'right', color: 'var(--info)' }}>{data?.conversionRate || 0}%</td>
                ...
                <tr>
                  ...
                  <td className="money" style={{ textAlign: 'right', color: '#6366F1' }}>{data?.approvedOrders || 0} approved</td>
                  <td style={{ textAlign: 'right', color: 'var(--accent)' }}>-</td>
                </tr>
                <tr>
                  <td style={{ fontWeight: 600, color: 'var(--danger)' }}>Total Expenses</td>
                  <td style={{ textAlign: 'right' }}>{data?.expenses?.length || 0}</td>
                  <td className="money" style={{ textAlign: 'right', color: 'var(--danger)' }}>{formatCurrency(data?.totalExpenses || 0)}</td>
                ...
                <tr style={{ background: (data?.profit || 0) >= 0 ? 'rgba(34,197,94,0.05)' : 'rgba(239,68,68,0.05)' }}>
                  ...
                  <td className="money" style={{ textAlign: 'right', color: (data?.profit || 0) >= 0 ? 'var(--success)' : 'var(--danger)' }}>{formatCurrency(data?.profit || 0)}</td>
              ...
              <tbody>
                {['Pending', 'Processing', 'Alternative', 'Delivered', 'Done'].map(status => (
                  <tr key={status}>
                    ...
                    <td className="money" style={{ textAlign: 'right' }}>{oStatus[status] || 0}</td>
                ...
                <tr style={{ background: 'rgba(99,102,241,0.05)' }}>
                  ...
                  <td className="money" style={{ textAlign: 'right', color: '#6366F1' }}>{data?.totalOrders || 0}</td>
                  <td style={{ textAlign: 'right', color: 'var(--accent)' }}>100%</td>
                </tr>
                <tr>
                  <td style={{ fontWeight: 600, color: 'var(--success)' }}>Approved</td>
                  <td className="money" style={{ textAlign: 'right', color: 'var(--success)' }}>{data?.approvedOrders || 0}</td>
                ...
                <tr>
                  ...
                  <td className="money" style={{ textAlign: 'right', color: '#F59E0B' }}>{(data?.totalOrders || 0) - (data?.approvedOrders || 0)}</td>
                  ...
                  <tbody>
                    {data.expensesByCategory.map(cat => (
                      <tr key={cat._id}>
                        ...
                        <td className="money" style={{ textAlign: 'right', color: 'var(--danger)' }}>{formatCurrency(cat.total)}</td>
            ...
            <table>
              ...
              <tbody>
                {['Draft', 'Sent', 'Accepted', 'Rejected', 'Converted'].map(status => (
                  <tr key={status}>
                    <td><StatusBadge status={status} /></td>
                    <td className="money" style={{ textAlign: 'right' }}>{qStatus[status]?.count || 0}</td>
                    <td className="money" style={{ textAlign: 'right' }}>{formatCurrency(qStatus[status]?.value || 0)}</td>
                ...
                <tr style={{ background: 'rgba(99,102,241,0.05)' }}>
                  ...
                  <td className="money" style={{ textAlign: 'right', color: '#6366F1' }}>{data?.totalQuotations || 0}</td>
                  <td className="money" style={{ textAlign: 'right', color: '#6366F1' }}>{formatCurrency(data?.totalQuotationValue || 0)}</td>
                  <td style={{ textAlign: 'right', color: 'var(--accent)' }}>100%</td>
                </tr>
              </tbody>
            </table>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="money" style={{ textAlign: 'right' }}>{data?.totalQuotations || 0}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="money" style={{ textAlign: 'right', color: '#6366F1' }}>{data?.convertedCount || 0}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="money" style={{ textAlign: 'right' }}>{data?.totalInvoices || 0}</td>
                </tr>
                <tr>
