  ...
  return (
    <Row className="g-4">
      <Col lg={8}>
        ...
        <div className="card-custom mb-4">
          <h5 className="form-section-title">Quotation Details</h5>
          <Row className="g-3">
            <Col md={4}>
              <Form.Group>
                <Form.Label className="form-label-custom">Quotation Date</Form.Label>
                <Form.Control className="form-input" type="date" value={quotationDate} onChange={e => setQuotationDate(e.target.value)} />
              </Form.Group>
            </Col>
            <Col md={4}>
              <Form.Group>
          ...
          <Row className="g-3">
            <Col md={6}>
              <Form.Group>
                ...
                <Form.Control className="form-input" as="textarea" rows={3} value={notes} onChange={e => setNotes(e.target.value)} placeholder="Additional notes..." />
              </Form.Group>
            </Col>
            <Col md={6}>
              <Form.Group>
                <Form.Label className="form-label-custom">Terms & Conditions</Form.Label>
                <Form.Control className="form-input" as="textarea" rows={3} value={terms} onChange={e => setTerms(e.target.value)} placeholder="Custom terms..." />
              </Form.Group>
            </Col>
          </Row>
        </div>
